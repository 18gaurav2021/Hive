...
//         { name: 'ModuleMaster', path: '/modulemaster' },
...
//   return (
//     <MainLayout>
//       <Grid container spacing={2} sx={{background: 'white', padding: '25px', borderRadius: '5px'}}>
//         {cardsData.map((card, index) => (
//           <Grid item xs={12} sm={6} md={4} key={index}>
//             <Card variant="outlined">
//               <CardContent>
//                 <Typography variant="h6" color='black' fontWeight="bold">{card.heading}</Typography>
//                 <Box sx={{padding: '10px 5px 5px 15px'}}>
//                 {card.subheadings.map((subheading, subIndex) => (
//                   <Box key={subIndex} sx={{paddingLeft: '20px'}}>
//                     <Link href={subheading.path} passHref={true} style={{color:'black'}}>
//                     <Typography variant="subtitle1" component="a" style={{color:'grey'}}>
//                     {subheading.name}
//                     </Typography>
//                     </Link>
//                   </Box>
                ...
                {card.subheadings.map((subheading, subIndex) => (
                  <Box key={subIndex} sx={{paddingLeft: '20px'}}>
                    <Link href={subheading.path} passHref>
                        <span style={{ textDecoration: 'underline', color: 'black', cursor: 'pointer' }}>
                          {subheading.name}
                        </span>
                      </Link>
                  </Box>
