...
const VendorForm = () => {
  ...
  return (
    ...
    >
      ...
      {/* <Grid item lg={9}>
        {buttonClicked === 'basic' && (
          // <VendorBasic setWareHouse={setWareHouse} />
        )}
        {buttonClicked === 'payment' && (
          // <VendorPayment setWareHouse={setWareHouse} />
        )}
        {buttonClicked === 'docs' && <VendorDocs setWareHouse={setWareHouse} />}
        {buttonClicked === 'warehouse' && <VendorWarehouse />}
      </Grid> */}
    </Grid>
    // </MainLayout>
  );
